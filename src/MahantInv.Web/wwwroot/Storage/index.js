...
ActionCellRenderer.prototype.init = function (params) {
    ...
    this.eGui.innerHTML = '<a href="#" class="link-primary" onclick="Common.OpenModal(this)" data-id="' + params.data.id + '" data-target="AddEditStorage" title="Edit"><i class="bi bi-pencil-square fs-6"></i></a>';
}
